...
def add_parts_1a(grader, submission):
    ...
    def t_1a_1():
        ...
        grader.requireIsEqual(
            "two words", submission.segmentWords("twowords", unigramCost)
        )
        grader.requireIsEqual(
    ...
    grader.addBasicPart(
        ...
        maxPoints=1,
        maxSeconds=2,
        description="simple test case using hand-picked unigram costs",
    )
    ...
    grader.addBasicPart(
        ...
        maxPoints=1,
        maxSeconds=2,
        description="simple test case using unigram cost from the corpus",
    )
    ...
    def t_1a_3():
        ...
        if solution_exist:
            grader.requireIsEqual(
                solution1, solution.segmentWords("pizza", unigramCost)
            )
            grader.requireIsEqual(
                solution2, solution.segmentWords("qqqqq", unigramCost)
            )
            grader.requireIsEqual(
                solution3, solution.segmentWords("z" * 100, unigramCost)
            )
            grader.requireIsEqual(solution4, solution.segmentWords("aa", unigramCost))
            grader.requireIsEqual(
                solution5, solution.segmentWords("aaaaaa", unigramCost)
            )
            grader.requireIsEqual(
                solution6, solution.segmentWords("aaaaaaa", unigramCost)
            )
    ...
    grader.addHiddenPart(
        ...
        maxPoints=3,
        maxSeconds=3,
        description="simple hidden test case",
    )
    ...
    def t_1a_4():
        for query in QUERIES_SEG:
            ...
            if solution_exist:
                grader.requireIsEqual(
                    pred, [solution.segmentWords(part, unigramCost) for part in parts]
                )
    ...
    grader.addHiddenPart(
        ...
        maxPoints=5,
        maxSeconds=3,
        description="hidden test case for all queries in QUERIES_SEG",
    )
...
def add_parts_1b(grader, submission):
    ...
    grader.addBasicPart(
        "1b-1-basic", t_1b_1, maxPoints=1, maxSeconds=2, description="simple test case"
    )
    ...
    def t_1b_2():
        ...
        solution4 = submission.insertVowels(
            "wld lk t hv mr lttrs".split(), bigramCost, possibleFills
        )
        solution5 = submission.insertVowels(
            "ngh lrdy".split(), bigramCost, possibleFills
        )

        if solution_exist:
            grader.requireIsEqual(
                solution1, solution.insertVowels([], bigramCost, possibleFills)
            )
            grader.requireIsEqual(
                solution2, solution.insertVowels(["zz$z$zz"], bigramCost, possibleFills)
            )
            grader.requireIsEqual(
                solution3, solution.insertVowels([""], bigramCost, possibleFills)
            )
            grader.requireIsEqual(
                solution4,
                solution.insertVowels(
                    "wld lk t hv mr lttrs".split(), bigramCost, possibleFills
                ),
            )
            grader.requireIsEqual(
                solution5,
                solution.insertVowels("ngh lrdy".split(), bigramCost, possibleFills),
            )
    ...
    def t_1b_3():
        ...
        if solution_exist:
            grader.requireIsEqual(
                solution1,
                solution.insertVowels(["x"], bigramCost, lambda x: set(["cat", "dog"])),
            )
        ...
        if solution_exist:
            grader.requireIsEqual(
                solution2, solution.insertVowels("x1 x2 x3".split(), bigramCost, fills)
            )
    ...
    def t_1b_4():
        for query in QUERIES_INS:
            ...
            if solution_exist:
                grader.requireIsEqual(
                    pred,
                    solution.insertVowels(copy.deepcopy(ws), bigramCost, possibleFills),
                )
    ...
    grader.addHiddenPart(
        ...
        maxPoints=3,
        maxSeconds=3,
        description="hidden test case for all queries in QUERIES_INS",
    )
...
def add_parts_1c(grader, submission):
    ...
    def t_1c_1():
        ...
        grader.requireIsEqual(
            "word", submission.segmentAndInsert("wrd", bigramCost, fills)
        )
        grader.requireIsEqual(
    ...
    grader.addBasicPart(
        ...
        maxPoints=1,
        maxSeconds=2,
        description="simple test case with hand-picked bigram costs and possible fills",
    )
    ...
    grader.addBasicPart(
        ...
        maxPoints=1,
        maxSeconds=2,
        description="simple test case with unigram costs as bigram costs",
    )
    ...
    def t_1c_3():
        ...
        if solution_exist:
            grader.requireIsEqual(
                solution1, solution.segmentAndInsert("wrd", bigramCost, fills)
            )
            grader.requireIsEqual(
                solution2, solution.segmentAndInsert("twwrds", bigramCost, fills)
            )
            grader.requireIsEqual(
                solution3, solution.segmentAndInsert("ndthrwrds", bigramCost, fills)
            )
    ...
    grader.addHiddenPart(
        ...
        maxPoints=3,
        maxSeconds=3,
        description="hidden test case with unigram costs as bigram costs and additional possible fills",
    )
    ...
    def t_1c_4():
        ...
        if solution_exist:
            grader.requireIsEqual(
                solution1, solution.segmentAndInsert("zzzzz", bigramCost, possibleFills)
            )
            grader.requireIsEqual(
                solution2, solution.segmentAndInsert("bm", bigramCost, possibleFills)
            )
            grader.requireIsEqual(
                solution3, solution.segmentAndInsert("mp", bigramCost, possibleFills)
            )
            grader.requireIsEqual(
                solution4,
                solution.segmentAndInsert("bmmpsctty", bigramCost, possibleFills),
            )
    ...
    grader.addHiddenPart(
        ...
        maxPoints=5,
        maxSeconds=3,
        description="hidden test case with hand-picked bigram costs and possible fills",
    )
        ...
        for query in QUERIES_BOTH:
            ...
            if solution_exist:
                grader.requireIsEqual(
                    pred,
                    [
                        solution.segmentAndInsert(part, smoothCost, possibleFills)
                        for part in parts
                    ],
                )
    ...
    grader.addHiddenPart(
        ...
        maxPoints=5,
        maxSeconds=3,
        description="hidden test case for all queries in QUERIES_BOTH with bigram costs and possible fills from the corpus",
    )
...
def add_parts_2a(grader, submission):
    ...
    def t_2a_1():
        ...
        grader.requireIsEqual(
            3, submission.UCSMazeSearch((1, 1), (1, 4), moveCost, possibleMoves)
        )
        grader.requireIsEqual(
            6, submission.UCSMazeSearch((1, 1), (4, 4), moveCost, possibleMoves)
        )
        grader.requireIsEqual(
            7, submission.UCSMazeSearch((1, 1), (4, 1), moveCost, possibleMoves)
        )
    ...
    grader.addBasicPart(
        ...
        maxPoints=1,
        maxSeconds=1,
        description="simple test case with small maze",
    )
    ...
    def t_2a_2():
        ...
        moveCost = util.CalculateMoveCost(
            map, moveCost={"LEFT": 1, "RIGHT": 2, "UP": 1, "DOWN": 2}
        )
        possibleMoves = util.FindPossibleMoves(map)

        grader.requireIsEqual(
            6, submission.UCSMazeSearch((1, 1), (1, 4), moveCost, possibleMoves)
        )
        grader.requireIsEqual(
            12, submission.UCSMazeSearch((1, 1), (4, 4), moveCost, possibleMoves)
        )
        grader.requireIsEqual(
            12, submission.UCSMazeSearch((1, 1), (4, 1), moveCost, possibleMoves)
        )
    ...
    def t_2a_3():
        ...
        if solution_exist:
            grader.requireIsEqual(
                solution1,
                solution.UCSMazeSearch((5, 40), (5, 90), moveCost, possibleMoves),
            )
            grader.requireIsEqual(
                solution2,
                solution.UCSMazeSearch((5, 20), (5, 90), moveCost, possibleMoves),
            )
    ...
    grader.addHiddenPart(
        ...
        maxPoints=1,
        maxSeconds=1,
        description="hidden test case where UCS becomes inefficient",
    )
...
def add_parts_2b(grader, submission):
    ...
    def t_2b_1():
        ...
        grader.requireIsEqual(
            8, submission.AStarMazeSearch((3, 6), (3, 14), moveCost, possibleMoves)
        )
    ...
    def t_2b_2():
        ...
        for _ in range(10):
            tm.check()
            pred_ucs = submission.UCSMazeSearch(
                (46, 46), (48, 48), moveCost, possibleMoves
            )
            time_sub_ucs = tm.elapsed()

            tm.check()
            pred_astar = submission.AStarMazeSearch(
                (46, 46), (48, 48), moveCost, possibleMoves
            )
            ...
            if solution_exist:
                tm.check()
                answer_ucs = solution.AStarMazeSearch(
                    (46, 46), (48, 48), moveCost, possibleMoves
                )
    ...
    grader.addHiddenPart(
        ...
        maxPoints=3,
        maxSeconds=3,
        description="hidden test case for maze search with A*",
    )
    ...
    def t_2b_3():
        ...
        for _ in range(10):
            tm.check()
            pred_ucs = submission.UCSMazeSearch(
                (5, 40), (5, 90), moveCost, possibleMoves
            )
            time_sub_ucs = tm.elapsed()
    ...
    grader.addHiddenPart(
        ...
        maxPoints=4,
        maxSeconds=3,
        description="hidden test case for maze search with A*, where UCS becomes inefficient",
    )
    ...
    def t_2b_4():
        ...
        moveCost = util.CalculateMoveCost(
            map, moveCost={"LEFT": 2, "RIGHT": 1, "UP": 2, "DOWN": 1}
        )
        possibleMoves = util.FindPossibleMoves(map)
    ...
    grader.addHiddenPart(
        ...
        maxPoints=4,
        maxSeconds=3,
        description="hidden test case for modified maze search with A*, where UCS becomes inefficient",
    )
